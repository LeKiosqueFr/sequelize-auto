      ...
      _.each(fields, function(field, i){
        ...
        _.each(fieldAttr, function(attr, x){
          ...
          if (attr === "foreignKey") {
            ...
            text[table] += spaces + spaces + spaces + "var adl = sequelize.import('./PR_ADL.js');\n";
            text[table] += spaces + spaces + spaces + "var product = sequelize.import('./PR_Production.js');\n";
            text[table] += spaces + spaces + spaces + "adl.hasOne(product, { as: 'product', foreignKey: 'idProduction'});\n";
            text[table] += spaces + spaces + spaces + "return adl;\n";
            text[table] += spaces + spaces + "};\n";
           }
          }
